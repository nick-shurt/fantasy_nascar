...
function get_all_time_standings($team_standings, $U_Name, $P_Word, $db) {
    ...
    $j = 0;
    while ($j < 10) {
		$winning_pct = ($all_time_stats[$j][1]/($all_time_stats[$j][1] + $all_time_stats[$j][2])) * 100;
...
function get_edit_lineup($num, $range, $team_roster, $driver_rank) {
    for ($i = $num; $i < $range; $i++) {
        ...
        echo '<input class="btn btn-warning" type="submit" value="Submit" name="submit" style="width: 150px; color: black; margin-top: 5px;">';
